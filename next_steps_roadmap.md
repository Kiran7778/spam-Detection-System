...
🎉 **Congratulations! You have completed the entire pipeline.**
...
## How to Run Your Completed Pipeline

Since all steps are built, here is how you can use the complete system:

```bash
# 1. Start the MLflow UI to view your tracking history
mlflow ui

# 2. Run the FastAPI endpoint
python step8_api.py
# -> test it out at http://127.0.0.1:8000/docs

# 3. View the Active Learning simulation
python step10_active_learning.py

# 4. If AWS is configured, run the AWS integration
python step11_aws_integration.py
```

> [!TIP]
> Awesome job bringing this adaptive spam moderator to life! You now have a production-ready model tracking with MLflow, served with FastAPI, capable of continuous improvement through Active Learning, and optionally wired to AWS for scalable human review.
