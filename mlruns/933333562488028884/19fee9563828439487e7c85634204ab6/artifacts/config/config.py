...
# ─── Active Learning & AWS Integration ───────────────────
# If confidence is below this, we send to human review (SQS)
CONFIDENCE_THRESHOLD = 0.85

# AWS Settings (Optional - will use mock if credentials missing)
AWS_REGION     = "us-east-1"
SQS_QUEUE_NAME = "adaptive-shield-review-queue"
S3_BUCKET_NAME = "adaptive-shield-labeled-data"
USE_MOCK_AWS   = True  # Set to False to try real AWS connection
